...
\setutbmabstract{
	...
	In this internship I explored how deep learning can be applied in action recognition and what the actual state-of-the-art is.
...
\begin{document}
	...
	There are several methods to compute dense optical flows, but the most known (and used) are the TV-L1 \cite{sanchez} and the Gunner Farnebäck \cite{farneback} algorithms.\\  % TODO: mathematical development of the two methods in appendix
