...
\begin{document}
		...
		\section{State-of-the-art}
			...
			\subsection{Two-stream architectures}\label{twostream}
				...
				\subsubsection{Literature}
					...
					Sudhakaran et al. \cite{sudhakaran2019lsta} pointed a major difficulty to action recognition in egocentric vision that is the \say{huge variations present in the data caused by the highly articulated nature of the human body}.
			...
			\subsection{EPIC-KITCHENS}
				...
				Note: However using a big dataset implies a finest management of the memory.% TODO: link to the RAM usage consideration
		\section{Studied methods}
			\subsection{Transfer Learning}
				...
				\subsubsection{Feature visualization}
					...
					This is useful to visualize which features a kernel, and more generally a layer, is looking for.
					\par
					...
					When trained on natural images, the first layer filters of the SDAE, are \say{Gabor-like features}.
				...
				Deeper, in \ref{block4}, we see more complex features, but still, they seem to combine basic features.
				Even deeper, in \ref{block8} and \ref{block12}, the observed features are far mroe complex and are probably revealing what type of features one can except from ImageNet images.
				...
				We provide in appendix \ref{app_a}, examples of both datasets to see how different they are.
				Even if basic features are common (edges, corners...), the high-level features to extract are not transferable from ImageNet to EPIC-KITCHENS.
	...
	\appendix
	\chapter{ImageNet and EPIC-KITCHENS comparisons}\label{app_a}
		\begin{figure}[h!]
			\centering
			\subfloat[EPIC-KITCHENS]{\includegraphics[width=0.4\textwidth]{epickitchens1.jpg}}
			\hfill
			\subfloat[ImageNet]{\includegraphics[width=0.35\textwidth]{imagenet1.jpeg}}
			\vfill
			\subfloat[EPIC-KITCHENS]{\includegraphics[width=0.4\textwidth]{epickitchens2.jpg}}
			\hfill
			\subfloat[ImageNet]{\includegraphics[width=0.35\textwidth]{imagenet2.jpeg}}
			\vfill
			\subfloat[EPIC-KITCHENS]{\includegraphics[width=0.4\textwidth]{epickitchens3.jpg}}
			\hfill
			\subfloat[ImageNet]{\includegraphics[width=0.35\textwidth]{imagenet3.jpeg}}
		\end{figure}
	\chapter{Appendix B}
		Lorem ipsum.
	\makeutbmbackcover{}
